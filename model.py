...
def U_net(pretrained_weights = None, input_size = (512,512,1)):
    ...
    up6 = ConvBNTranspose(256, 4, drop_cross)##(UpSampling2D(size = (2,2))(conv_cross))
    merge6 = concatenate([drop4, up6], axis = 3)
    conv6 = ConvBN(256, 3, merge6)
    conv6 = ConvBN(256, 3, conv6)
                                                                                       
    up7 = ConvBNTranspose(128, 4, conv6)##(UpSampling2D(size = (2,2))(conv6))
    merge7 = concatenate([conv3,up7], axis = 3)
    conv7 = ConvBN(128, 3,merge7)
    conv7 = ConvBN(128, 3,conv7)

    up8 = ConvBNTranspose(64, 4, conv7)##(UpSampling2D(size = (2,2))(conv7))
    merge8 = concatenate([conv2,up8], axis = 3)
    conv8 = ConvBN(64, 3, merge8)
    conv8 = ConvBN(64, 3, conv8)

    up9 = ConvBNTranspose(32, 4, conv8)##(UpSampling2D(size = (2,2))(conv8))
    ...
    OutImage = Conv2D(1, 3, activation = 'sigmoid')(conv9)
